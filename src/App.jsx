...
const PRODUCT_TREE = [
  {
    ...
    rows:[
      ...
      { key:'Milestones',     children:[] },
      { key:'Streaks',        children:[] },
      { key:'Benefit Categories',    children:['View benefit categories list','View benefit category details','Create benefit category','Update benefit category','Change status of benefit category'] },
      { key:'Tiers',                 children:['View tiers list','View tier details','Create tiers','Update tiers','Submit tiers for review','Delete draft (tier)','Approve or reject tiers'] },
      { key:'Subscription Programs', children:['View subscription program list','View subscription program details','Create subscription program','Update subscription program','Change status of subscription program','Discard draft on published subscription','Approve or reject subscription program'] },
      { key:'Config Attributes',     children:['View loyalty config attributes','View loyalty config attributes scopes','Create loyalty config attributes','Update loyalty config attributes'] },
      { key:'Loyalty Benefits',      children:['View loyalty benefit list','View loyalty benefit details','Create loyalty benefit','Update loyalty benefit','Change status of loyalty benefit','Discard draft on published loyalty benefit','Approve or reject loyalty benefit'] },
    ]
  },
  {
    id:'engage', label:'Engage',
...
const MODULE_PERMS = {
  ...
  'View benefit categories list':          ['View'],
  'View benefit category details':         ['View'],
  'Create benefit category':               ['Create'],
  'Update benefit category':               ['Edit'],
  'Change status of benefit category':     ['Edit'],
  'Tiers':                                 ['View','Create','Edit','Delete','Approval'],
  'View tiers list':                       ['View'],
  'View tier details':                     ['View'],
  'Create tiers':                          ['Create'],
  'Update tiers':                          ['Edit'],
  'Submit tiers for review':               ['Edit'],
  'Delete draft (tier)':                   ['Delete'],
  'Approve or reject tiers':               ['Approval'],
  'Subscription Programs':                 ['View','Create','Edit','Delete','Approval'],
  'View subscription program list':        ['View'],
  'View subscription program details':     ['View'],
  'Create subscription program':           ['Create'],
  'Update subscription program':           ['Edit'],
  'Change status of subscription program': ['Edit'],
  'Discard draft on published subscription':['Delete'],
  'Approve or reject subscription program':['Approval'],
  'Config Attributes':                     ['View','Create','Edit'],
  'View loyalty config attributes':        ['View'],
  'View loyalty config attributes scopes': ['View'],
  'Create loyalty config attributes':      ['Create'],
  'Update loyalty config attributes':      ['Edit'],
  'Loyalty Benefits':                      ['View','Create','Edit','Delete','Approval'],
  'View loyalty benefit list':             ['View'],
  'View loyalty benefit details':          ['View'],
  'Create loyalty benefit':                ['Create'],
  'Update loyalty benefit':                ['Edit'],
  'Change status of loyalty benefit':      ['Edit'],
  'Discard draft on published loyalty benefit':['Delete'],
  'Approve or reject loyalty benefit':     ['Approval'],
